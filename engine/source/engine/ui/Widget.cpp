...
namespace gswy {
	...
	void MainMenu::Render()
	{
		...
		ImGui::Begin("A new world", &IsVisible, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoDecoration);
		float f = 0.0;
	...
	void HUD::Render()
	{
		...
		ImGui::Begin("Wave", &IsVisible, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoDecoration);
		ImGui::Text("Wave 0");
		ImGui::End();
		...
		ImGui::Begin("Mana", &IsVisible, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoDecoration);
		...
		ImGui::Begin("Sanity", &IsVisible, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoDecoration);
		ImGui::ProgressBar(0.5f);
		ImGui::End();
	}
	...
	void PauseMenu::Render()
	{
		...
		ImGui::Begin("A new world", &IsVisible, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_NoBackground);
		float f = 0.0;
		ImGui::SetWindowFontScale(1.0);
	...
	void ShopMenu::Render()
	{
		...
		ImGui::Begin("Shop", &IsVisible, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoDecoration);
	...
	void InventoryMenu::Render()
	{
		...
		ImGui::Begin("Inventory", &IsVisible, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoDecoration);
